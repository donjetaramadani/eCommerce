...
<body>
    <!-- Header from the second HTML code -->
    <header class="header">
    ...
    <!-- Content from the first HTML code -->
    <section>
        <!-- Product cards and other content here -->
    </section>
    ...
    <div class="cart">
        ...
        <div class="total"></div>
        <button class="submit-button" onclick="goToInformationPage()">Proceed to Checkout</button>
        &copy; 2023 Gallery Shop. All rights reserved.
</div>
    <!-- Footer from the second HTML code -->
    <footer class="footer">
        <div class="container">
            <div class="row">
